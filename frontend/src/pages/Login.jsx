    ...
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-amber-50 to-red-50">
      <div className="bg-white p-10 rounded-2xl shadow-xl w-full max-w-md border border-amber-100">
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-amber-700 mt-2">Medical Management System</p>
        </div>
        ...
        <div className="mt-6 text-center">
          <p className="text-gray-600">
            Doctor?{' '}
            <a href="/register-doctor" className="font-medium text-amber-600 hover:text-red-600 hover:underline transition duration-200">
              Register here
            </a>
          </p>
        </div>
